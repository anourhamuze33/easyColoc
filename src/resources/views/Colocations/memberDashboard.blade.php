...
<head>
  ...
  <style>
    ...
    *::after {
    ...
    .act-green {
      background: rgba(82, 201, 122, 0.08);
      border: 1px solid rgba(82, 201, 122, 0.15);
    }
...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav>
      ...
      <div class="nav-section">
        ...
        <a class="nav-item" href="{{route('index')}}"><span class="ni">⬡</span> Mon profil</a>
  ...
  <main class="main">
    ...
    <div class="topbar">
      ...
      <div class="topbar-right">
        ...
        <button class="btn btn-outline" onclick="document.getElementById('m-invite').style.display='flex'">+
          Inviter</button>
    ...
    <div class="content">
      ...
      <div class="grid-main">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div style="display:flex;gap:8px;align-items:center;">
              <select
                style="background:var(--noir3);border:1px solid #222;color:var(--text2);font-family:system-ui;font-size:0.68rem;padding:4px 8px;border-radius:5px;outline:none;cursor:pointer;">
          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                <td><span style="color:var(--text);font-size:0.78rem;">Courses Carrefour</span><br><span
                    style="font-size:0.62rem;opacity:0.4;">20 fév. 2026</span></td>
                <td><span class="tag tg-green">Alimentation</span></td>
                <td>
                  <div style="display:flex;align-items:center;gap:6px;">
                    <div class="mini-av" style="background:linear-gradient(135deg,#c9a84c,#7a5c1a);color:#0a0a0a;">JD
                    </div> Jean
                  </div>
                </td>
              ...
              <tr>
                <td><span style="color:var(--text);font-size:0.78rem;">EDF Électricité</span><br><span
                    style="font-size:0.62rem;opacity:0.4;">18 fév. 2026</span></td>
                <td><span class="tag tg-blue">Énergie</span></td>
                <td>
                  <div style="display:flex;align-items:center;gap:6px;">
                    <div class="mini-av av-b">ML</div> Marie
                  </div>
                </td>
              ...
              <tr>
                <td><span style="color:var(--text);font-size:0.78rem;">Netflix</span><br><span
                    style="font-size:0.62rem;opacity:0.4;">15 fév. 2026</span></td>
                <td><span class="tag tg-gray">Loisirs</span></td>
                <td>
                  <div style="display:flex;align-items:center;gap:6px;">
                    <div class="mini-av av-c">AR</div> Alex
                  </div>
                </td>
              ...
              <tr>
                <td><span style="color:var(--text);font-size:0.78rem;">Loyer Février</span><br><span
                    style="font-size:0.62rem;opacity:0.4;">01 fév. 2026</span></td>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="debt-row">
              <div class="avatar av-b" style="width:30px;height:30px;font-size:0.6rem;border-radius:7px;flex-shrink:0;">
                ML</div>
              <div class="debt-info">
            ...
            <div class="debt-row">
              <div class="avatar av-c" style="width:30px;height:30px;font-size:0.6rem;border-radius:7px;flex-shrink:0;">
                AR</div>
              <div class="debt-info">
            ...
            <div class="debt-row">
              <div class="avatar av-d" style="width:30px;height:30px;font-size:0.6rem;border-radius:7px;flex-shrink:0;">
                TR</div>
              <div class="debt-info">
            ...
            <div
              style="font-size:0.6rem;letter-spacing:0.08em;text-transform:uppercase;color:var(--muted);margin-bottom:10px;">
              Ma balance globale</div>
            <div
              style="background:rgba(82,201,122,0.05);border:1px solid rgba(82,201,122,0.14);border-radius:8px;padding:11px 14px;display:flex;justify-content:space-between;align-items:center;">
            ...
            <div style="font-size:0.6rem;color:var(--muted);margin-top:5px;text-align:right;">72% des dettes
              régularisées ce mois</div>
          </div>
        </div>
      </div>
      ...
      <div class="card a4">
        <div class="card-header">
          ...
          <button class="btn btn-outline" onclick="document.getElementById('modal-invite').style.display='flex'">+
  ...
  <!-- MODAL Invitation -->
  <div id="m-invite" class="modal-overlay" style="display:none;"
    onclick="if(event.target===this)this.style.display='none'">
    <div class="modal">
      <div class="modal-header">
        <div class="modal-title">Inviter un membre</div>
        <button class="btn btn-ghost" style="padding:4px 8px;"
          onclick="document.getElementById('m-invite').style.display='none'">✕</button>
      </div>
      <div class="modal-body">
        <form action="{{route('colocation.invite')}}" method="POST">
          @csrf
          <div>
            <label class="form-label-m">Adresse email</label>
            <input class="form-input-m" name="email" type="email" placeholder="exemple@email.com">
          </div>

          <div class="modal-footer">
            <button class="btn btn-outline"
              onclick="document.getElementById('m-invite').style.display='none'">Annuler</button>
